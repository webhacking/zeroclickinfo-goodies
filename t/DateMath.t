...
location_test([ qw( DDG::Goodie::DateMath ) ],
    ...
    '32 days from January 1st 2012' => build_test('02 Feb 2012', '01 Jan 2012 + 32 days'),
    # Relative (to today)
    '6 weeks ago'              => build_test('01 Dec 2013', '12 Jan 2014 - 6 weeks'),
    '2 weeks from today'       => build_test('26 Jan 2014', '12 Jan 2014 + 2 weeks'),
    'in 3 weeks'               => build_test('02 Feb 2014', '12 Jan 2014 + 3 weeks'),
    ...
    'date today plus 24 hours' => build_test('13 Jan 2014 00:00:00 IST', '12 Jan 2014 00:00:00 IST + 24 hours'),
    # time form
    'time 3 days ago' => build_test('09 Jan 2014 15:30:00 IST', '12 Jan 2014 15:30:00 IST - 3 days'),
    # Specifying time
    ...
    '1 day from 1/1/2012'     => build_test('02 Jan 2012', '01 Jan 2012 + 1 day'),
    ...
    # Casing
    '3 Years Ago'          => build_test('12 Jan 2011', '12 Jan 2014 - 3 years'),
    ...
    'What date will it be in 3 days'    => build_test('15 Jan 2014', '12 Jan 2014 + 3 days'),
    'What will the date be in 3 days?'  => build_test('15 Jan 2014', '12 Jan 2014 + 3 days'),
    'What date is it in 3 days'         => build_test('15 Jan 2014', '12 Jan 2014 + 3 days'),
    'What time was it 3 days ago'       => build_test('09 Jan 2014 15:30:00 IST', '12 Jan 2014 15:30:00 IST - 3 days'),
    'What date was it 3 days ago'       => build_test('09 Jan 2014', '12 Jan 2014 - 3 days'),
    'What date was it 3 days ago?'      => build_test('09 Jan 2014', '12 Jan 2014 - 3 days'),
    'What day was it 3 days ago?'       => build_test('09 Jan 2014', '12 Jan 2014 - 3 days'),
    # Specified relative
    'date 21st Jan'     => undef,
