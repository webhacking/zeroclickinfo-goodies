...
location_test([ qw( DDG::Goodie::DateMath ) ],
    ...
    '32 days from January 1st 2012' => build_test('02 Feb 2012', '32 days from january 1st 2012'),
    # Relative (to today)
    '6 weeks ago'              => build_test('01 Dec 2013', '6 weeks ago'),
    '2 weeks from today'       => build_test('26 Jan 2014', '2 weeks from today'),
    ...
    '5 minutes from now'       => build_test('12 Jan 2014 15:35:00 IST', '5 minutes from now'),
    'in 5 minutes'             => build_test('12 Jan 2014 15:35:00 IST', 'In 5 minutes'),
    'in 5 minutes.'            => build_test('12 Jan 2014 15:35:00 IST', 'In 5 minutes'),
    'time in 5 minutes'        => build_test('12 Jan 2014 15:35:00 IST', 'In 5 minutes'),
    'twelve seconds ago'       => build_test('12 Jan 2014 15:29:48 IST', '12 seconds ago'),
    ...
    '1 day from 1/1/2012'     => build_test('02 Jan 2012', '1 day from 1/1/2012'),
    ...
    # With wrapping
    'What time will it be in 3 minutes' => build_test('12 Jan 2014 15:33:00 IST', 'In 3 minutes'),
    'What is the time in 3 minutes'     => build_test('12 Jan 2014 15:33:00 IST', 'In 3 minutes'),
    'What was the time 3 minutes ago'   => build_test('12 Jan 2014 15:27:00 IST', '3 minutes ago'),
